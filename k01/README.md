...
```
s_mean: 173.888750
s_variance:25.361711
p_mean:173.888750 p:1.903445
p_variance:28.984813
```
...
- 入出力結果は，ソースコードから出力されたままをコピペしてください．
- ちなみに，平均は，saveではなくaveではないでしょうか．

[comment #20200811-2 sonoda]
- OK!
