...
- 私のところで実行したところうまくいっています．上の「入出力結果」に実際の実行結果をコピペしてください．
  - `gcc -o k03 k03.c`で作って，`k03 170.8 5.43 5`した結果と，
  - `gcc -o k03 k03.c -DCONST_SEED`で作って，`k03 170.8 5.43 5`した結果
  の２つです．

[comment #20200811 sonoda]
- 私のところでうまくいっているので，完了としますが，上記のコメントのように
  - `gcc -o k03 k03.c`で作って，`./k03 170.8 5.43 5`した結果と，
  - `gcc -o k03_const k03.c -DCONST_SEED`で作って，`./k03_const 170.8 5.43 5`した結果
  の２つの結果をかいてください．
